...
API_ID = int(environ.get('API_ID', '19382005'))
API_HASH = environ.get('API_HASH', '5caf8072682a5a752eac8ac88b4355e8')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002211803799'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5098018742').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002160829800').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://bhandaripunit927:heaVFrVUWqFvRYVo@cluster0.xhvpbs0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'MoviezzMania007') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
